...
function Wordmark() {
  return (
    <Link
      href="/"
      className="group inline-flex items-center transition-transform duration-300 hover:-translate-y-px"
      aria-label="Kuza home"
    >
      {/* blue-ink logo for the light nav bar */}
      <img
        src="/images/logos/kuza_logo_horizontal_light_blue.svg"
        alt="Kuza"
        width={75}
        height={28}
    ...
    <header className="sticky top-0 z-50 border-b border-line bg-white/90 backdrop-blur-md">
      <nav className="mx-auto flex h-16 max-w-6xl items-center justify-between px-5 md:px-8">
        ...
        <div className="hidden items-center gap-3 md:flex">
          ...
          <a
            href={REGISTER_URL}
            className="group rounded-full bg-leaf px-5 py-2.5 text-[0.95rem] font-semibold text-white shadow-lift transition-all duration-300 hover:-translate-y-0.5 hover:bg-leaf-dark hover:shadow-lift"
          >
            Start free
          </a>
        </div>
