...
## 13. Brand commitment (marketing surfaces)
Standing preference (owner-set, 2026-07-29): **clean, conversion-first modern SaaS** at the craft level of Bumpa (getbumpa.com) and the Paystack-tier Nigerian fintech standard — executed straight, no vernacular pastiche. Kuza's own rendition: deep growth-green + amber accent on white/off-white grounds (distinct from Bumpa's navy/teal), real African merchant photography (assets in `img/`), hand-built product-UI mockups proving the mechanism, benefit-led conversational copy, Naira-first illustrative pricing. Durable visual tokens live in DESIGN.md.
