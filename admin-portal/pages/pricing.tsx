...
const GROUP_ORDER: Array<'vertical' | 'common' | 'assist'> = ['vertical', 'common', 'assist'];
    ...
    setConfig((prev) => {
      ...
      return {
        ...
        apps: prev.apps.map((a) =>
          a.key === appKey ? { ...a, prices: { ...a.prices, [currency]: toPrice(value) } } : a,
        ),
      };
    });
  };
  ...
  return (
    <div className="w-full space-y-5">
      <PageHeader
        ...
        breadcrumbs={[{ label: 'Tenants', href: '/tenants' }, { label: 'Pricing' }]}
        actions={
