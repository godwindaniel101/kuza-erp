...
export const WEBSITE_TEMPLATES: WebsiteTemplate[] = [
  ...
  /* ── 2. Electronics — split hero, zigzag numbered features, banner ───── */
  {
    ...
    outline: ['hero', 'features', 'products', 'gallery', 'cta', 'contact'],
    sections: () => [
      ...
      features({
        ...
        items: [
          feat('Engineered for pure performance', 'Precisely crafted to deliver exceptional sound, comfort and clarity.', 'bx-target-lock'),
          feat('Technology that elevates every moment', 'Advanced acoustic architecture for immersive sound and intelligent noise control.', 'bx-music'),
          feat('Minimal design, maximum impact', 'A timeless silhouette that fits seamlessly into your life and your world.', 'bx-diamond'),
        ],
      }),
      products({ variant: 'grid', bg: 'tint', heading: 'The lineup' }),
      gallery({ variant: 'wide', heading: 'In your world', images: [U('1546435770-a3e426bf472b', 1200), U('1618366712010-f4ae9c647dcb', 1200)] }),
  ...
  /* ── 6. Grocery — fresh light, icon features, image-left ──────────────── */
  {
    ...
    sections: () => [
      ...
      gallery({ variant: 'wide', heading: 'On the shelves today', images: [U('1550989460-0adf9ea622e2', 1200), U('1488459716781-31db52582fe9', 1200)] }),
  ...
  /* ── 9. Food Delivery (testyfo) — warm, icon features, banner ────────── */
  {
    ...
    sections: () => [
      ...
      stats({ bg: 'warm', heading: '', items: [stat('30 min', 'Average delivery'), stat('4.9★', 'Rider rating'), stat('120+', 'Dishes to pick from')] }),
  ...
  /* ── 15. Patisserie — warm rose, product cards, image-left, card CTA ─── */
  {
    ...
    sections: () => [
      ...
      gallery({ variant: 'masonry', bg: 'warm', heading: 'From the counter', images: [U('1550439062-609e1531270e', 1200), U('1571260899304-425eee4c7efc', 1200), U('1467003909585-2f8a72700288', 1200), U('1509440159596-0249088772ff', 1200), U('1442512595331-e89e73853f31', 1200), U('1502741224143-90386d7f8c82', 1200)] }),
  ...
  /* ── 20. SaaS — violet, stats, features, pricing, testimonial, banner ── */
  {
    ...
    sections: () => [
      ...
      gallery({ variant: 'wide', heading: 'Inside the product', images: [U('1551288049-bebda4e38f71', 1200), U('1460925895917-afdab827c52f', 1200)] }),
  ...
  /* ── 22. Plant Shop — dark green, product-GRID-led, banner ───────────── */
  {
    ...
    sections: () => [
      ...
      gallery({ variant: 'grid', bg: 'dark', heading: 'Styled at home', images: [U('1416879595882-3373a0480b5b', 1200), U('1466692476868-aef1dfb1e735', 1200), U('1512428813834-c702c7702b78', 1200), U('1462530260150-162092dbf011', 1200), U('1485955900006-10f4d324d411', 1200), U('1493957988430-a5f2e15f39a3', 1200)] }),
