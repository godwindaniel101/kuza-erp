...
export default function Dashboard() {
  ...
  return (
    <PermissionGuard permission="dashboard.view">
      <div className="space-y-5 kz-stagger">
        {/* Period filter */}
        <div className="flex items-center justify-end">
          ...
          <select
            ...
            className="h-9 w-40 rounded-lg border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 px-3 text-[13px] font-medium text-gray-900 dark:text-gray-100 focus:outline-none focus-visible:ring-2 focus-visible:ring-accent-ring"
          >
