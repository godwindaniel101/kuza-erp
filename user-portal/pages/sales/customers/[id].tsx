      ...
      {loading ? (
        ...
        <>
          ...
          <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-card ring-1 ring-gray-950/[0.04] dark:ring-gray-800 p-5 mb-6">
            <h2 className="font-display text-[15px] font-semibold tracking-tight text-gray-900 dark:text-gray-100 mb-4">{t('customers.profile', 'Profile')}</h2>
          ...
          <div className="flex items-center justify-between mb-3">
            <h2 className="font-display text-[15px] font-semibold tracking-tight text-gray-900 dark:text-gray-100">{t('customers.invoices', 'Invoices')}</h2>
            <Link
