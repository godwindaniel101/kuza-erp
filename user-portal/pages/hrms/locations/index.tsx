                ...
                <table className="w-full">
                  <thead className="bg-gray-50 dark:bg-gray-900">
                    <tr>
                      ...
                      <th className="px-4 py-2.5 text-left text-[11px] font-medium text-gray-500 dark:text-gray-400">{t('address')}</th>
                      <th className="px-4 py-2.5 text-left text-[11px] font-medium text-gray-500 dark:text-gray-400">{t('city')}</th>
                      <th className="px-4 py-2.5 text-left text-[11px] font-medium text-gray-500 dark:text-gray-400">{t('country')}</th>
