...
const DEPT_BAR_TONES = ['bg-accent', 'bg-emerald-500', 'bg-amber-500', 'bg-sky-500', 'bg-rose-500', 'bg-violet-500'];
  ...
  return (
    <div className="space-y-6 kz-stagger">
      <div className="flex flex-wrap items-center justify-end gap-2">
        <Link href="/hrms/departments/create" className={heroActionGhost}>
          <i className="bx bx-buildings" aria-hidden="true" /> Department
        </Link>
        <Link href="/hrms/employees/create" className={heroActionPrimary}>
          <i className="bx bx-plus" aria-hidden="true" /> Add Employee
        </Link>
      </div>
              ...
              {deptDist.map((d, i) => (
                <div key={d.name}>
                  <div className="mb-1 flex items-center justify-between text-[13px]">
                    ...
                    <span className="font-medium text-gray-900 dark:text-gray-100 tabular-nums">{d.count}</span>
                  </div>
          ...
          <div className="grid grid-cols-2 gap-3 pt-1">
            {[
              ...
              <div key={b.label} className={`rounded-xl p-3 ${b.bg}`}>
                <p className={`font-display text-2xl font-bold tabular-nums ${b.tone}`}>{b.value}</p>
      ...
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
        ...
        <Card padding={false}>
          <div className="flex items-center justify-between border-b border-gray-100 dark:border-gray-800 px-5 py-3">
            <h3 className="font-display text-sm font-semibold tracking-tight text-gray-900 dark:text-gray-100">Recent employees</h3>
        ...
        <Card padding={false}>
          <div className="flex items-center justify-between border-b border-gray-100 dark:border-gray-800 px-5 py-3">
            <h3 className="font-display text-sm font-semibold tracking-tight text-gray-900 dark:text-gray-100">Leave requests</h3>
