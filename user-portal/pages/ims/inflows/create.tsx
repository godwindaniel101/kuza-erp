          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div>
              ...
              <input
                ...
                className="h-9 w-full px-4 border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 rounded-md focus:outline-none focus-visible:ring-1 focus-visible:ring-accent-ring focus-visible:border-transparent text-[13px]"
              />
          ...
          {showNotes && (
            <div className="mt-4">
              ...
              <textarea
                ...
                rows={3}
                className="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 rounded-md focus:outline-none focus-visible:ring-1 focus-visible:ring-accent-ring focus-visible:border-transparent resize-none"
          ...
          <div className="grid grid-cols-1 md:grid-cols-[2fr_1fr_1fr_1fr_1fr_1fr_auto] gap-4 mb-4">
            ...
            <div>
              <button
                ...
                className="w-full px-3 py-2 bg-accent text-white rounded-lg hover:bg-accent-hover disabled:opacity-50 disabled:cursor-not-allowed transition-colors flex items-center justify-center min-h-[48px]"
              ...
              <div className="mt-4 pt-4 border-t border-gray-200 dark:border-gray-800">
                <div className="grid grid-cols-1 md:grid-cols-7 gap-4">
                  <div className="md:col-span-7 flex flex-row items-center justify-end">
                    ...
                    <div className="px-4 py-3 bg-red-50 dark:bg-red-500/10 ring-1 ring-red-500/30 rounded-lg text-lg font-display font-bold tabular-nums tracking-tight text-red-700 dark:text-red-400">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <textarea
                ...
                rows={3}
                className="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 rounded-md focus:outline-none focus-visible:ring-1 focus-visible:ring-accent-ring focus-visible:border-transparent"
