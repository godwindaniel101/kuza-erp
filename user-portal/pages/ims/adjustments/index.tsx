      ...
      render: (a) =>
        a.branchName ? (
          <span className="inline-flex items-center gap-1.5 text-gray-700 dark:text-gray-300">
            <Icon name="building-storefront" size={16} className="text-gray-400" />
            {a.branchName}
          </span>
        ) : (
        ...
        actions={
          <>
            ...
            <Link
              ...
              className="h-8 px-3 bg-accent text-accent-fg rounded-lg text-[13px] font-medium hover:bg-accent-hover transition-colors active:scale-[0.98] inline-flex items-center gap-1.5"
            >
        ...
        emptyState={
          <EmptyState
            ...
            actions={
              <Link
                href="/ims/adjustments/new"
                className="h-8 px-3 bg-accent text-accent-fg rounded-lg text-[13px] font-medium hover:bg-accent-hover transition-colors active:scale-[0.98] flex items-center"
              >
                {t('adjustments.new', 'New Adjustment')}
              </Link>
            }
