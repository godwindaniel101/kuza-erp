...
export default function NewAdjustmentPage() {
  ...
  return (
    <div className="mx-auto w-full max-w-3xl space-y-6 kz-stagger">
      <PageHeader
              ...
              <div key={row.key} className="px-6 py-3 grid grid-cols-12 gap-3 items-center">
                ...
                <div className="col-span-2">
                  <input
                    ...
                    className={`h-9 w-full px-3 text-[13px] text-right tabular-nums border rounded-lg focus:outline-none focus-visible:ring-1 focus-visible:ring-accent-ring dark:bg-gray-800 dark:text-gray-100 border-gray-300 dark:border-gray-600 transition-colors ${
 qty > 0 ? 'text-emerald-600 dark:text-emerald-400' : qty < 0 ? 'text-red-600 dark:text-red-400' : ''
 }`}
                  />
                </div>
        ...
        <div className="px-6 py-3 border-t border-gray-200 dark:border-gray-700">
          <button
            ...
            className="px-3 py-2 text-sm text-accent hover:bg-accent-soft rounded-lg inline-flex items-center gap-1.5 transition-colors"
          >
