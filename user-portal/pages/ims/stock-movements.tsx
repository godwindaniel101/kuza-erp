      ...
      render: (m) =>
        m.branchName ? (
          <span className="inline-flex items-center gap-1 text-gray-700 dark:text-gray-300">
            <Icon name="building-storefront" size={16} className="text-gray-400" aria-hidden="true" />
            {m.branchName}
          </span>
        ) : (
            ...
            actions={
              <div className="flex items-center gap-2">
                ...
                <input
                  ...
                  className="h-9 px-3 text-[13px] border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 rounded-md focus:outline-none focus-visible:ring-1 focus-visible:ring-accent-ring"
                />
