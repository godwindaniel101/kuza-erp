  ...
  return (
    <div className="space-y-6 kz-stagger">
      <div className="flex items-center justify-end gap-2">
        <Link
          href="/ims/inflows"
          className="inline-flex items-center gap-1.5 h-9 px-4 rounded-lg text-[13px] font-semibold text-gray-700 dark:text-gray-200 ring-1 ring-inset ring-gray-300 dark:ring-gray-700 hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors"
        >
          <Icon name="inbox-arrow" size={16} /> {t('inventory.receiveStock', 'Receive Stock')}
        </Link>
        <Link
          href="/ims/inventory"
          className="inline-flex items-center gap-1.5 h-9 px-4 rounded-lg text-[13px] font-semibold text-white bg-accent-gradient hover:bg-accent-gradient-hover shadow-sm transition-all"
        >
          <Icon name="plus" size={16} /> {t('inventory.addItem', 'Add Item')}
        </Link>
      </div>
      ...
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
        ...
        <Card padding={false}>
          <div className="flex items-center justify-between border-b border-gray-100 dark:border-gray-800 px-5 pt-2">
            ...
            <Link href="/ims/inventory" className="text-[13px] font-medium text-accent hover:underline">
                  ...
                  <div key={r.key} className="flex items-center justify-between px-5 py-3">
                    <div className="min-w-0">
                      ...
                      <p className="truncate text-xs text-gray-500">
                        <span className="inline-flex items-center gap-1"><Icon name="building-storefront" size={14} className="text-gray-400" />{r.branchName}</span>
        ...
        <Card padding={false}>
          <div className="flex items-center justify-between border-b border-gray-100 dark:border-gray-800 px-5 py-3">
            <h3 className="font-display text-[15px] font-semibold tracking-tight text-gray-900 dark:text-gray-100">{t('inventory.recentMovements', 'Recent movements')}</h3>
            <Link href="/ims/stock-movements" className="text-[13px] font-medium text-accent hover:underline">
                    ...
                    return (
                      <tr key={m.id}>
                        <td className="px-5 py-2.5">
                          ...
                          {m.branchName && (
                            <p className="truncate text-xs text-gray-400 inline-flex items-center gap-1"><Icon name="building-storefront" size={14} /> {m.branchName}</p>
                          )}
                        </td>
      ...
      <Modal
        ...
        footer={
          drill?.href ? (
            <Link
              href={drill.href}
              className="inline-flex h-9 items-center rounded-lg bg-accent-gradient px-4 text-[13px] font-semibold text-white hover:opacity-90"
            >
