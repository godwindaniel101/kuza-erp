...
export default function CreateTransferPage() {
  ...
  return (
    ...
    <div className="max-w-3xl space-y-6 kz-stagger">
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
          ...
          <div>
            ...
            <input
              ...
              className="h-9 w-full rounded-md border border-gray-200 px-3 text-sm focus:outline-none focus-visible:ring-2 focus-visible:ring-accent-ring dark:border-gray-700 dark:bg-gray-800 dark:text-gray-100"
            />
          </div>
        </div>
      </div>
      ...
      <div className="rounded-2xl bg-white p-6 shadow-card ring-1 ring-gray-950/[0.04] dark:bg-gray-900 dark:ring-gray-800">
        <h3 className="mb-3 font-display text-[15px] font-semibold tracking-tight text-gray-900 dark:text-gray-100">{t('items', 'Items')}</h3>
