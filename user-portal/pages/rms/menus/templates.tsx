      ...
      <div className="kz-stagger max-w-7xl mx-auto space-y-6">
        ...
        <div>
          <button
            ...
            className="w-full p-5 bg-accent-gradient hover:bg-accent-gradient-hover text-accent-fg rounded-2xl transition-colors duration-150 flex items-center justify-between group focus:outline-none focus-visible:ring-2 focus-visible:ring-accent-ring focus-visible:ring-offset-2 dark:focus-visible:ring-offset-gray-950"
          >
            <div className="flex items-center space-x-4">
              ...
              <div className="text-left">
                <h3 className="font-display tracking-tight text-sm font-semibold">{t('aiDesigner') || 'AI Designer'}</h3>
        ...
        {/* Templates Grid */}
        <div>
          <h2 className="font-display tracking-tight text-[15px] font-semibold text-gray-900 dark:text-gray-100 mb-4">{t('orChooseTemplate') || 'Or Choose a Template'}</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {templates.map((template) => (
              <div
                key={template.id}
                className="kz-lift bg-white dark:bg-gray-900 rounded-2xl shadow-card ring-1 ring-gray-950/[0.04] dark:ring-gray-800 hover:ring-accent-ring cursor-pointer overflow-hidden group"
              ...
              >
                ...
                {/* Template Info */}
                <div className="p-5">
                  <h3 className="font-display tracking-tight text-sm font-semibold text-gray-900 dark:text-gray-100 mb-2">{template.name}</h3>
