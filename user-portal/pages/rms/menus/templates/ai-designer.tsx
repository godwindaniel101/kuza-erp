...
export default function AiDesignerPage() {
  ...
  return (
    <PermissionGuard permission="menus.edit">
      <div className="kz-stagger max-w-4xl mx-auto h-[calc(100vh-8rem)] flex flex-col">
        {toast && (
        ...
        {/* Messages */}
        <div className="flex-1 overflow-y-auto bg-white dark:bg-gray-900 rounded-2xl shadow-card ring-1 ring-gray-950/[0.04] dark:ring-gray-800 p-5 mb-4">
        ...
        <form onSubmit={handleSendMessage} className="flex-shrink-0">
          <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-card ring-1 ring-gray-950/[0.04] dark:ring-gray-800 p-3">
            <div className="flex space-x-3">
              <input
                ...
                className="h-9 flex-1 px-3 text-sm border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 rounded-md focus:outline-none focus-visible:ring-2 focus-visible:ring-accent-ring focus-visible:border-transparent"
                disabled={sending}
              />
