...
/** Share-of-total inline bar. Text wears gray tokens; the bar carries the accent magnitude. */
const SHARE_BAR_COLOR = 'var(--accent)';
...
export default function ReportsPage() {
  ...
  const tableShell = (title: string, meta: string, children: React.ReactNode) => (
    <section className="overflow-hidden rounded-2xl bg-white dark:bg-gray-900 ring-1 ring-gray-950/[0.04] dark:ring-gray-800 shadow-card">
      <div className="flex items-center justify-between border-b border-gray-100 dark:border-gray-800 px-4 py-3">
        ...
        <span className="text-xs tabular-nums text-gray-500 dark:text-gray-400">{meta}</span>
      </div>
      {children}
    </section>
  );
  ...
  return (
    <PermissionGuard permission="reports.view">
      <div className="kz-stagger space-y-6">
          ...
          actions={
            ...
            <div className="w-40 shrink-0">
              <select
                ...
                className="h-9 w-full rounded-lg border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 px-3 text-sm text-gray-900 dark:text-gray-100 focus:outline-none focus-visible:ring-2 focus-visible:ring-accent-ring focus-visible:border-transparent"
              >
        ...
        <div className="grid grid-cols-2 divide-y divide-gray-100 dark:divide-gray-800 sm:divide-y-0 sm:divide-x rounded-2xl bg-white dark:bg-gray-900 ring-1 ring-gray-950/[0.04] dark:ring-gray-800 shadow-card sm:grid-cols-4">
