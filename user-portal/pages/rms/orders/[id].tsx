    ...
    <PermissionGuard permission="orders.view">
      <div className="kz-stagger w-full max-w-5xl space-y-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 items-stretch">
          ...
          <div className="lg:col-span-2 bg-white dark:bg-gray-900 rounded-2xl shadow-card ring-1 ring-gray-950/[0.04] dark:ring-gray-800 p-6 flex flex-col">
            <h2 className="font-display text-[15px] font-semibold tracking-tight text-gray-900 dark:text-gray-100 mb-3">{t('orderInformation') || 'Order Information'}</h2>
            
            <div className="flex-1">
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-x-6 gap-y-4">
                <div>
                  <label className="text-xs font-medium text-gray-500 dark:text-gray-400">{t('orderNumber')}</label>
                  <p className="text-sm text-gray-900 dark:text-gray-100 mt-1 tabular-nums">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-x-6 gap-y-4 mt-4 pt-4 border-t border-gray-200 dark:border-gray-700">
                <div>
                  ...
                  <p className="font-display text-lg font-bold text-gray-700 dark:text-gray-300 mt-1 tabular-nums">{formatCurrency(totalCost)}</p>
                </div>

                <div>
                  <label className="text-xs font-medium text-gray-500 dark:text-gray-400">{t('sales')}</label>
                  <p className="font-display text-lg font-bold text-gray-900 dark:text-gray-100 mt-1 tabular-nums">{formatCurrency(totalSale)}</p>
                </div>

                <div>
                  <label className="text-xs font-medium text-gray-500 dark:text-gray-400">{t('profit')}</label>
                  <p className={`font-display text-lg font-bold mt-1 tabular-nums ${profit >= 0 ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400'}`}>
          ...
          <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-card ring-1 ring-gray-950/[0.04] dark:ring-gray-800 p-6 flex flex-col">
            <h2 className="font-display text-[15px] font-semibold tracking-tight text-gray-900 dark:text-gray-100 mb-3">{t('paymentHistory') || 'Payment History'}</h2>
            ...
            <div className="space-y-2.5 mb-3">
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <p className="font-display text-lg font-bold text-gray-900 dark:text-gray-100 mt-1 tabular-nums">{formatCurrency(Number(order.totalAmount || 0))}</p>
                </div>
                <div>
                  <label className="text-xs font-medium text-gray-500 dark:text-gray-400">{t('totalPaid') || 'Total Paid'}</label>
                  <p className="font-display text-lg font-bold text-green-600 dark:text-green-400 mt-1 tabular-nums">
              ...
              <div>
                ...
                <p className="font-display text-lg font-bold text-red-600 dark:text-red-400 mt-1 tabular-nums">
                    ...
                    {order.payments.map((payment: any, index: number) => (
                      <div key={index} className="border-b border-gray-200 dark:border-gray-700 pb-3 last:border-b-0 last:pb-0">
                        <div className="flex justify-between items-start mb-1">
                          <div>
                            <p className="text-sm font-medium text-gray-900 dark:text-gray-100 tabular-nums">{formatCurrency(Number(payment.amount || 0))}</p>
        ...
        <div className="mt-6">
          <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-card ring-1 ring-gray-950/[0.04] dark:ring-gray-800">
              <div className="p-6 border-b border-gray-200 dark:border-gray-700">
                <h2 className="font-display text-[15px] font-semibold tracking-tight text-gray-900 dark:text-gray-100">{t('orderItems') || 'Order Items'}</h2>
              </div>
                                    ...
                                    <div className="rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 p-4">
                                      ...
                                      <div className="overflow-x-auto">
                                        <table className="w-full">
                                          <thead>
                                            <tr className="bg-purple-50 dark:bg-purple-900/20 text-purple-700 dark:text-purple-300">
