        ...
        <div className="flex items-start gap-4 min-w-0">
          ...
          <div className="min-w-0">
            <div className="flex items-center flex-wrap gap-2">
              ...
              {r.source === 'online' && (
                <span className="inline-flex items-center gap-1 px-1.5 py-0.5 text-[11px] font-medium rounded-full bg-accent-soft text-accent ring-1 ring-inset ring-accent-ring/25">
  ...
  return (
    <PermissionGuard permission="reservations.view">
      <div className="kz-stagger space-y-6">
        ...
        {/* Filter bar */}
        <div className="bg-white dark:bg-gray-900 ring-1 ring-gray-950/[0.04] dark:ring-gray-800 shadow-card rounded-xl p-4 space-y-3">
            ...
            <div className="inline-flex rounded-lg bg-gray-100 dark:bg-gray-800 p-0.5">
              {(['calendar', 'day'] as const).map((m) => (
                <button
                  ...
                  className={`inline-flex items-center gap-1.5 px-3 py-1.5 rounded-md text-[13px] font-medium transition-colors duration-150 focus:outline-none focus-visible:ring-2 focus-visible:ring-accent-ring ${
                    viewMode === m
            ...
            {viewMode === 'calendar' ? (
              ...
              <div className="flex items-center gap-1.5">
                ...
                <input
                  ...
                  className="h-9 px-3 text-sm border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 rounded-md focus:outline-none focus-visible:ring-2 focus-visible:ring-accent-ring focus-visible:border-transparent"
                />
        ...
        {loading ? (
          ...
          /* ------------------------------- Month calendar grid ------------------------------- */
          <div className="bg-white dark:bg-gray-900 ring-1 ring-gray-950/[0.04] dark:ring-gray-800 shadow-card rounded-xl overflow-hidden">
            {/* Weekday headers */}
              ...
              {calendarCells.map((cell, idx) => {
                ...
                return (
                  <div
                    ...
                    className={`flex flex-col gap-1 min-h-[92px] sm:min-h-[116px] p-1.5 text-left cursor-pointer border-b border-r border-gray-100 dark:border-gray-800 focus:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-accent-ring hover:bg-gray-50 dark:hover:bg-gray-800/50 ${
                      idx % 7 === 6 ? 'border-r-0' : ''
                    } ${idx >= 35 ? 'border-b-0' : ''} ${
          ...
          <div className="max-w-3xl mx-auto space-y-3">
            ...
            {sorted.length === 0 ? (
              <EmptyState
                ...
                title={t('noReservations') || 'No reservations'}
                description={
              ...
              <input
                ...
                className={`w-full h-9 px-3 text-sm border rounded-md bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 focus:outline-none focus-visible:ring-2 focus-visible:border-transparent transition-colors ${
                  errors.time
                    ...
                    : 'focus-visible:ring-accent-ring border-gray-300 dark:border-gray-700'
                }`}
              />
              {errors.time && (
