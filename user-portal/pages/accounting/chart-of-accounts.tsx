            ...
            return (
              ...
              >
                <div className="px-4 py-3 bg-gray-50 dark:bg-gray-900 border-b border-gray-200 dark:border-gray-700 flex items-center justify-between">
                  <h2 className="flex items-center gap-2 font-display text-[15px] font-semibold tracking-tight text-gray-900 dark:text-gray-100">
                  ...
                  <span className="text-xs text-gray-500 dark:text-gray-400 tabular-nums">{rows.length} accounts</span>
                </div>
                          ...
                          {!account.isSystem ? (
                            <div className="flex items-center justify-end gap-1">
                              <button
                                ...
                                title="Edit"
                                className="h-9 w-9 inline-flex items-center justify-center rounded-lg text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700"
                              >
