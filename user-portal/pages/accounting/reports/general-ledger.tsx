...
export default function GeneralLedgerPage() {
  ...
  return (
    <div className="w-full max-w-5xl space-y-6 kz-stagger">
      ...
      {/* Filters */}
      <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-card ring-1 ring-gray-950/[0.04] dark:ring-gray-800 p-4 flex flex-col sm:flex-row flex-wrap gap-3 items-start sm:items-center">
          ...
          <div className="overflow-x-auto">
            <table className="min-w-full divide-y divide-gray-100 dark:divide-gray-800">
              <thead className="bg-gray-50 dark:bg-gray-900">
                <tr>
                  <th className="px-4 py-2.5 text-left text-[11px] font-medium text-gray-500 dark:text-gray-400">Date</th>
                  <th className="px-4 py-2.5 text-left text-[11px] font-medium text-gray-500 dark:text-gray-400">Entry #</th>
                  <th className="px-4 py-2.5 text-left text-[11px] font-medium text-gray-500 dark:text-gray-400">Memo / Description</th>
                  ...
                  <th className="px-4 py-2.5 text-right text-[11px] font-medium text-gray-500 dark:text-gray-400">Balance</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-gray-100 dark:divide-gray-800">
                <tr className="bg-gray-50/60 dark:bg-gray-900/40">
                  ...
                  <td className="px-4 py-3 whitespace-nowrap text-sm text-right font-medium tabular-nums text-gray-900 dark:text-white">
                ...
                {data.rows.length === 0 ? (
                  ...
                  data.rows.map((row, i) => (
                    <tr key={`${row.entryNumber}-${i}`} className="hover:bg-gray-50 dark:hover:bg-gray-800/50">
                      ...
                      <td className="px-4 py-3 whitespace-nowrap text-sm font-medium tabular-nums text-gray-900 dark:text-white">{row.entryNumber}</td>
              ...
              <tfoot className="bg-gray-50 dark:bg-gray-900">
                <tr>
                  ...
                  <td className="px-4 py-3 whitespace-nowrap text-sm text-right font-semibold tabular-nums text-gray-900 dark:text-white">
