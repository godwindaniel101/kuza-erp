        ...
        {reports.map((report) => (
          ...
          >
            <div className="flex items-start gap-4">
              <div className="h-12 w-12 rounded-lg bg-accent-soft flex items-center justify-center shrink-0">
                <i className={`bx ${report.icon} text-2xl text-accent`} aria-hidden="true"></i>
              </div>
              <div>
                <h3 className="font-display font-semibold tracking-tight text-gray-900 dark:text-white group-hover:text-accent transition-colors flex items-center gap-1">
                  {report.title}
