          ...
          >
            <div className="flex items-center gap-3">
              <i
                className={`bx ${profitable ? 'bx-trending-up' : 'bx-trending-down'} text-2xl ${
                  profitable ? 'text-emerald-600 dark:text-emerald-400' : 'text-red-600 dark:text-red-400'
                }`}
                aria-hidden="true"
              ></i>
              <span
                className={`text-sm font-medium ${
                  profitable ? 'text-emerald-800 dark:text-emerald-300' : 'text-red-800 dark:text-red-300'
                }`}
              >
            ...
            <span
              className={`font-display text-2xl font-semibold tracking-tight tabular-nums ${
                profitable ? 'text-emerald-700 dark:text-emerald-300' : 'text-red-700 dark:text-red-300'
              }`}
            >
