...
export default function NewJournalEntryPage() {
  ...
  return (
    <div className="w-full max-w-3xl space-y-6 kz-stagger">
      ...
      {/* Header fields */}
      <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-card ring-1 ring-gray-950/[0.04] dark:ring-gray-800 p-6 grid grid-cols-1 sm:grid-cols-3 gap-4">
      ...
      <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-card ring-1 ring-gray-950/[0.04] dark:ring-gray-800 overflow-visible">
        <div className="px-6 py-3 bg-gray-50 dark:bg-gray-900 border-b border-gray-200 dark:border-gray-700 grid grid-cols-12 gap-3 text-[11px] font-medium text-gray-500 dark:text-gray-400">
            ...
            <div key={line.key} className="px-6 py-3 grid grid-cols-12 gap-3 items-center">
              ...
              <div className="col-span-3">
                <input
                  ...
                  className="h-9 w-full px-3 text-[13px] border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 rounded-lg focus:outline-none focus-visible:ring-2 focus-visible:ring-accent-ring"
                />
              </div>
              <div className="col-span-2">
                <input
                  ...
                  placeholder="0.00"
                  aria-label="Debit"
                  className="h-9 w-full px-3 text-[13px] text-right tabular-nums border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 rounded-lg focus:outline-none focus-visible:ring-2 focus-visible:ring-accent-ring"
                />
              </div>
              <div className="col-span-2">
                <input
        ...
        <div className="px-6 py-3 border-t border-gray-200 dark:border-gray-700 flex items-center justify-between flex-wrap gap-3">
          ...
          <div
            className={`flex items-center gap-6 text-sm font-semibold px-4 py-2 rounded-xl ${
              balanced
          ...
          >
            <span>
              Σ Debit: <span className="tabular-nums">{formatMoney(totalDebit, currency)}</span>
            </span>
            <span>
              Σ Credit: <span className="tabular-nums">{formatMoney(totalCredit, currency)}</span>
            </span>
            {balanced ? (
