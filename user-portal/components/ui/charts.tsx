...
// Series 1 follows the current vertical ACCENT (globals.css --accent) so charts
// dress for the service being rendered. Series 2 / positive stay fixed so
// multi-series comparisons remain legible and semantically stable.
export const SERIES_1 = 'var(--accent)';
