          ...
          <nav className="-mb-px flex gap-6" aria-label="Tabs">
            {tabs.map((tab) => (
              <button
                ...
                className={
                  activeTab === tab.key
                    ? 'whitespace-nowrap border-b-2 border-brand-600 dark:border-brand-400 py-2.5 px-1 text-[13px] font-medium text-brand-600 dark:text-brand-400'
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  <input
                    ...
                    placeholder="0"
                    className="h-9 w-full px-3 border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 rounded-md focus:outline-none focus-visible:ring-1 focus-visible:ring-brand-500 focus-visible:border-transparent text-[13px] tabular-nums"
                  />
                </div>
                <div>
                  <label className="block text-xs font-medium text-gray-500 dark:text-gray-400 mb-1">
