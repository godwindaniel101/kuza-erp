    ...
    return (
      <div className="p-6">
        <div className="text-center py-12">
          <div className="animate-spin rounded-full h-8 w-8 border-b-2 border-brand-600 dark:border-red-400 mx-auto"></div>
        ...
        {activeTab === "details" && (
          <div className="w-full max-w-5xl space-y-5">
            ...
            {inflow.failedUploads && inflow.failedUploads.length > 0 && (
              <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-card ring-1 ring-gray-950/[0.04] dark:ring-gray-800 border border-gray-200 dark:border-gray-700 max-w-4xl">
