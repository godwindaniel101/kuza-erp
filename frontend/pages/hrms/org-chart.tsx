    ...
    <PermissionGuard permission="employees.view">
      <div className="w-full max-w-4xl space-y-5">
        ...
        {loading ? (
          ...
          <div className="mx-auto flex max-w-md flex-col items-center gap-3 rounded-2xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 px-6 py-12 text-center">
